...
print(X0.shape)
for el in range(L-1):
    # E0 = np.tensordot(np.conj(mps_state.right_tensors[el]), mps_state.right_tensors[el],((0,2),(0,2)))
    ...
    # E0 = np.tensordot( E0, (0,1) )
    
    # E0 = np.tensordot( np.conj(mps_state.right_tensors[el]), mps_state.right_tensors[el], (2,2) )
    # print("----", E0.shape)
    # E0 = E0.transpose((0,2,1,3))
    # print("----", E0.shape)
    # X0 = np.tensordot( X0, E0, ([0,1],[0,1]) )
    # print("--", X0)
    print('\n')
